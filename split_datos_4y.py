...
# Find all 4y files
files_4y = [f for f in os.listdir(data_dir) if f.endswith('_4h_4y.csv')]

for filename in files_4y:
    ...
    # Guardar
    base_name = filename.replace('_4h_4y.csv', '')
    in_path = os.path.join(data_dir, f'{base_name}_4h_4y_in_sample.csv')
    out_path = os.path.join(data_dir, f'{base_name}_4h_4y_out_sample.csv')
