...
# ============================================================
# 1. ESTRATEGIA RSI MEAN-REVERSION
# ============================================================
...
df = pd.read_csv('/home/alancito/trading-bot/datos/historicos/btc_usdt_4h_in_sample.csv')
...
reglas = [
    ...
    ("4. Datos suficientes (1+ año, varios regímenes)", "✅", f"In-sample: {len(df)} velas 4h = ~17 meses"),
...
try:
    fig = cerebro.plot(style='candlestick', barup='green', bardown='red', 
                       volume=False, 
                       savefig=dict(fname='resultado_rsi.png', dpi=150, bbox_inches='tight'))[0][0]
    print("Gráfica guardada como: resultado_rsi.png")
