...
# ============================================================
# MAIN: EJECUTAR EN IN-SAMPLE DE 1h DE LOS 5 PARES
# ============================================================
if __name__ == '__main__':
    ...
    print(f"\n{'='*80}")
    print(f"EVALUACIÓN RSI MEAN-REVERSION EN 5 PARES (IN-SAMPLE 1h, 4 AÑOS)")
    ...
    # Tabla comparativa
    print(f"\n{'='*100}")
    print(f"TABLA COMPARATIVA RSI MEAN-REVERSION (IN-SAMPLE 1h, 4 AÑOS)")
    print(f"{'='*100}")
    ...
    print(f"{'='*100}")
    print(f"CONCLUSIÓN: ¿El cambio a 1h aumenta las señales a ≥30 trades por par?")
