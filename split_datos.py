...
data_path = os.path.join(project_dir, 'data/btc_usdt_1h.csv')
...
# Guardar
in_path = os.path.join(project_dir, 'data/btc_usdt_1h_in_sample.csv')
out_path = os.path.join(project_dir, 'data/btc_usdt_1h_out_sample.csv')
